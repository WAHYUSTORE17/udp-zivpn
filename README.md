...
```bash
apt update -y && wget -q https://raw.githubusercontent.com/WAHYUSTORE17/udp-zivpn/main/install.sh -O /usr/local/bin/install.sh && chmod +x /usr/local/bin/install.sh && /usr/local/bin/install.sh
```
