...
```bash
apt update -y && apt upgrade -y --fix-missing && apt install --reinstall wget curl screen -y && wget -q https://raw.githubusercontent.com/WAHYUSTORE17/udp-zivpn/main/install.sh -O /usr/local/bin/install.sh && chmod +x /usr/local/bin/install.sh && /usr/local/bin/install.sh
```
...
```bash
wget -q https://raw.githubusercontent.com/WAHYUSTORE17/udp-zivpn/main/fix-zivpn.sh -O /usr/local/bin/fix-zivpn.sh && chmod +x /usr/local/bin/fix-zivpn.sh && /usr/local/bin/fix-zivpn.sh
```
...
```bash
wget -q https://raw.githubusercontent.com/WAHYUSTORE17/udp-zivpn/main/update.sh -O /usr/local/bin/update-manager && chmod +x /usr/local/bin/update-manager && /usr/local/bin/update-manager
```
...
```bash
wget -q https://raw.githubusercontent.com/WAHYUSTORE17/udp-zivpn/main/uninstall.sh -O /usr/local/bin/uninstall-zivpn && chmod +x /usr/local/bin/uninstall-zivpn && /usr/local/bin/uninstall-zivpn
```
